            ...
            <div className="w-full md:w-7/12 p-5 md:p-10 flex flex-col justify-between">
                <div className="flex flex-col justify-center gap-3 md:pt-12 md:px-10">
                    ...
                    <h1>
                        ...
                        proficiency in both front-end and back-end technologies, I specialize in crafting dynamic
                        interfaces and seamless functionality. I have honed my skills to build dynamic and interactive
